    ...
    <header id="header">
       <div className="row1">
          ...
          <div className="row1-1 login">
             <a href="!#" title="일반회원" className="login-member login-sub-down-btn">일반</a>
             <a href="!#" title="회원" className='header-login-btn login-sub-down-btn'><div className='login-text'></div><img src="./img/ico_down_16x10.png" alt=""/></a>
             ...
             <i>|</i>
             <a href="<?=$path3?>member_center/" title="고객센터">고객센터<img src="<?=$path3?>img/ico_down_16x10.png" alt=""/></a>
          </div>
